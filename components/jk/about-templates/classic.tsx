...
/* Template « classic » de la page À-propos — mise en page historique (maquette
 * écran 04) : portrait en situation à gauche, texte à la première personne à
 * droite, cartel en pied. Extrait tel quel de la page. */

export function AboutClassic({ about }: AboutTemplateProps) {
